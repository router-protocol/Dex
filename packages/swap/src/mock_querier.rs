...
pub struct WasmMockQuerier {
    ...
    swap_factory_querier: SwapFactoryQuerier,
}
...
#[derive(Clone, Default)]
pub struct SwapFactoryQuerier {
    pairs: HashMap<String, PairInfo>,
    native_token_decimals: HashMap<String, u8>,
}

impl SwapFactoryQuerier {
...
impl WasmMockQuerier {
    pub fn new(base: MockQuerier) -> Self {
        WasmMockQuerier {
            ...
            swap_factory_querier: SwapFactoryQuerier::default(),
        }
    }
    ...
    // configure the swap pair
    pub fn with_swap_factory(
        &mut self,
        pairs: &[(&String, &PairInfo)],
        native_token_decimals: &[(String, u8)],
    ) {
        self.swap_factory_querier = SwapFactoryQuerier::new(pairs, native_token_decimals);
    }
