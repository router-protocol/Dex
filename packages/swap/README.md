...
This is a collection of common types and the queriers which are commonly used in swap contracts.
...
It also provides the query interface to query avaliable swap pair contract info. Any contract can query pair info to swap factory contract.
...
It also provides the query interface to query avaliable swap pair contract info. Any contract can query pair info to pair contract.
