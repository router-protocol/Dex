...
This is mainly used from swap factory contract to create new swap pair. It initializes all swap created parameters which can be updated later with owner key.
