...
use std::ops::Mul;
use std::str::FromStr;
use swap::asset::{Asset, AssetInfo, PairInfo, PairInfoRaw};
use swap::pair::{
    Cw20HookMsg, ExecuteMsg, InstantiateMsg, MigrateMsg, PoolResponse, QueryMsg,
    ReverseSimulationResponse, SimulationResponse,
};
use swap::querier::query_token_info;
use swap::token::InstantiateMsg as TokenInstantiateMsg;
use swap::util::migrate_version;

// version info for migration info
const CONTRACT_NAME: &str = "crates.io:swap-pair";
    ...
    Ok(Response::new().add_submessage(SubMsg {
        ...
        msg: WasmMsg::Instantiate {
            ...
            msg: to_binary(&TokenInstantiateMsg {
                name: "swap liquidity token".to_string(),
