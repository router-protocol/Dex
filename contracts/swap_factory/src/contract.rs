...
use swap::querier::{query_balance, query_pair_info_from_pair};
...
use swap::asset::{Asset, AssetInfo, AssetInfoRaw, PairInfo, PairInfoRaw};
use swap::factory::{
...
const CONTRACT_NAME: &str = "crates.io:swap-factory";
